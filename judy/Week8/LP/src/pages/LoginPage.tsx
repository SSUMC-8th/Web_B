...
export const LoginPage = () => {
  ...
  return (
    <div className="bg-black flex justify-center pt-20 text-white">
      <div className="flex flex-col">
        ...
        {/* 소셜 로그인 */}
        <Link
          className="w-60 h-10 flex items-center justify-between px-3 border-2 border-white rounded-md mb-5 cursor-pointer"
          to={"http://localhost:8000/v1/auth/google/login"}
        >
